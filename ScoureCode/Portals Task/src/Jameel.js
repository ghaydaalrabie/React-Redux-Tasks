...
const styles = {
  ...
  button: { display: "flex", marginLeft: "auto", marginBottom: 12, top:-30, right:1300 }
};

ReactDOM.render(<Jameel />, document.getElementById("react-root"));

export default Jameel
